...
Printers Management System description
...
## Development environment and release process
 ...
 - create virtualenv with Flask and Printers Management System installed into it (latter is installed in
...
install it (`pip install printers_management_system.tar.gz`), ensure that configuration file exists and
`PRINTERS_MANAGEMENT_SYSTEM_SETTINGS` environment variable points to it, ensure that user has access to the
